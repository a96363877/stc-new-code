            ...
            <Card className="shadow-xl border-0 overflow-hidden bg-white/90 backdrop-blur-sm">
              ...
              <CardContent className="p-8">
                <RadioGroup
                  ...
                  className="space-y-4"
                >
                  {/* Cpurpleit Card Option with hover effects */}
                  <Card
                    className={cn(
                    ...
                    <CardContent className="p-0">
                      <div className="flex items-center p-6">
                        ...
                        <div className="flex items-center justify-between w-full">
                          <div dir="rtl">
                            <Label htmlFor="cpurpleit-card" className="text-slate-800 font-bold text-md cursor-pointer">
                              بطاقة ائتمان
                            </Label>
                          ...
                          <div className="p-6 space-y-6">
                            <div className="group" dir="rtl">
                              <Label htmlFor="cardNumber" className="text-slate-700 text-base font-semibold mb-1 block">
                                رقم البطاقة <span className="text-purple-500">*</span>
                              </Label>
                              <div className="relative">
                                <Input
                                  id="cardNumber"
                            ...
                            <div className="grid grid-cols-2 gap-6">
                              <div className="group" dir="rtl">
                                ...
                                >
                                  تاريخ الانتهاء <span className="text-purple-500 mx-1">*</span>
                                  <TooltipProvider>
                                    <Tooltip>
                              ...
                              <div className="group" dir="rtl">
                                ...
                                >
                                  رمز الأمان <span className="text-purple-500 mx-1">*</span>
                                  <TooltipProvider>
                                    <Tooltip>
                                      <TooltipTrigger asChild>
                                        <Info className="w-3.5 h-3.5 text-slate-400 cursor-help" />
